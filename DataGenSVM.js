...
// Calculate NDVI, NDWI, SWM 
var ndvi = sentinel2.normalizedDifference(['B8', 'B4']).rename('NDVI');
//var ndwi = sentinel2.normalizedDifference(['B3', 'B8']).rename('NDWI');  //not used
...
var featureImage = ndvi.addBands(swm);
...
//Number of training points annotated for each class
var NUM_OF_PIXELS = 50000
...
// Water: 0: blue, Buildings: 1: red, Sparse veg: 2: yellow, Dense veg: 3: green
var classVis = {
  min: 0,
  max: 3,
...
//Map.addLayer(swm.clip(geometry), {min: -1, max: 3, palette: ['white', 'blue']}, 'SWM');
